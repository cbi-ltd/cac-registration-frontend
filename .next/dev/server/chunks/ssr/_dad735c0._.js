...
function StatusPage() {
    ...
    const downloadBlob = async (endpoint, transactionRef, filename)=>{
        ...
        setError("");
        try {
            const resp = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE_URL"]}${endpoint}`, {
                method: "POST",
                headers: {
