  ...
  const checkPaymentStatus = React.useCallback(async () => {
    ...
    try {
      ...
      const resp = await fetch(
        `https://cac-registration-backend.onrender.com/api/payments/checkout/status/${store.paymentReference}`,
      );
  ...
  return (
    <div className="space-y-6 animate-slide-up">
      ...
      >
        ...
        {/* {checking && (<div className="flex items-center gap-2 text-sm text-muted-foreground">
