  ...
  return (
    <div className="w-full py-6 px-3 sm:px-6">
            ...
            return (
              ...
              >
                <div className="relative shrink-0">
                  ...
                  <div
                    className={`relative z-10 size-9 sm:w-12 sm:h-12 rounded-full flex items-center justify-center font-semibold transition-all duration-300 shadow-lg shrink-0 ${
                      isComplete
                  ...
                  >
                    {isComplete ? (
                      <CheckCircle2 className="size-5 sm:w-6 sm:h-6" />
                    ) : (
                      stepNum
                    )}
                  </div>
      ...
      <div className="mt-8 sm:mt-10 text-center text-xs sm:text-sm text-muted-foreground">
        Step{" "}
        <span className="font-semibold text-foreground">{currentStep}</span> of{" "}
        {totalSteps}
      </div>
    </div>
  );
